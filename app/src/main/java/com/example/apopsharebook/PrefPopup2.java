...
public class PrefPopup2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pref_popup2);
        prefs = new ArrayList<>();
...
//                startActivity(intent);
                if(!prefs.isEmpty()) {
                    ...
                    startActivity(new Intent(PrefPopup2.this,AdminMenu.class));
                } else {
                    Toast.makeText(PrefPopup2.this, "Select Preferences", Toast.LENGTH_SHORT).show();
                }
            }
        });
